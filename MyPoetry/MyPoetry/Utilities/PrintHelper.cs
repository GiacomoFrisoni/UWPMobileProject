...
namespace MyPoetry.Utilities
{
    ...
    public class PrintHelper
    {
        ...
        /// <summary>
        /// The percent of app's margin height, content is set at 92% (0.92) of tha area's height
        /// </summary>
        protected const double ApplicationContentMarginTop = 0.04;
        ...
        protected Canvas PrintCanvas
        {
            get
            {
                return scenarioUc.FindName("PrintCanvas") as Canvas;
            }
        }
